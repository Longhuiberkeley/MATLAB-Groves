...
%     meas_omega_ib_b = meas_omega_ib_b - est_IMU_bias(4:6);
    ...
    [est_r_eb_e,est_v_eb_e,est_C_b_e,P_matrix] = Prediction(tor_i,old_est_C_b_e,old_est_r_eb_e,old_est_v_eb_e,...
    est_IMU_bias, P_matrix,meas_f_ib_b,meas_omega_ib_b,...
    est_L_b,TC_KF_config);


%     [est_C_b_e,est_v_eb_e,est_r_eb_e,est_IMU_bias,est_clock,P_matrix] = NonHolocorrection(est_C_b_e,...
...
%        GPS correction customized
%         [est_C_b_e,est_v_eb_e,est_r_eb_e,est_IMU_bias,est_clock,P_matrix] = GPScorrection(GNSS_measurements,no_GNSS_meas,tor_s,est_C_b_e,...
%             est_v_eb_e,est_r_eb_e,est_IMU_bias,est_clock,P_matrix,...
%             TC_KF_config);

        [est_C_b_e,est_v_eb_e,est_r_eb_e,est_IMU_bias,est_clock,P_matrix] = Totalcorrection(GNSS_measurements,no_GNSS_meas,tor_s,est_C_b_e,...
            est_v_eb_e,est_r_eb_e,est_IMU_bias,est_clock,P_matrix,...
            TC_KF_config, Vehicle_config);
